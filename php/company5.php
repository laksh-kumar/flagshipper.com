...
<body>
    ...
    <div class="nav-bar">
        ...
        <a href="index17.php"><div class="responsive" >
            <div class="gallery" >
                    <img src="images/<?php echo $phone17["sr."]?>.jpg" alt="image" width="100%;" >
                <div class="desc">
                    <h5><?php echo $phone17["name"]?></h5>
                    <h6>PKR <?php echo $phone17["pkr"]?></h6>
                </div>
            </div>
        </div></a>
        <a href="index18.php"><div class="responsive" >
            <div class="gallery" >
                    <img src="images/<?php echo $phone18["sr."]?>.jpg" alt="image" width="100%;" >
                <div class="desc">
                    <h5><?php echo $phone18["name"]?></h5>
                    <h6>PKR <?php echo $phone18["pkr"]?></h6>
                </div>
            </div>
        </div></a>
