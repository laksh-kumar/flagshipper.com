...
<body>
    ...
    <div class="nav-bar">
        ...
        <a href="index19.php"><div class="responsive" >
            <div class="gallery" >
                    <img src="images/<?php echo $phone19["sr."]?>.jpg" alt="image" width="100%;" >
                <div class="desc">
                    <h5><?php echo $phone19["name"]?></h5>
                    <h6>PKR <?php echo $phone19["pkr"]?></h6>
                </div>
            </div>
        </div></a>
        <a href="index20.php"><div class="responsive" >
            <div class="gallery" >
                    <img src="images/<?php echo $phone20["sr."]?>.jpg" alt="image" width="100%;" >
                <div class="desc">
                    <h5><?php echo $phone20["name"]?></h5>
                    <h6>PKR <?php echo $phone20["pkr"]?></h6>
                </div>
            </div>
        </div></a>
