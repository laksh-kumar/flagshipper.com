...
<body>
    ...
    <div class="nav-bar">
        ...
        <a href="index11.php"><div class="responsive" >
            <div class="gallery" >
                    <img src="images/<?php echo $phone11["sr."]?>.jpg" alt="image" width="100%;" >
                <div class="desc">
                    <h5><?php echo $phone11["name"]?></h5>
                    <h6>PKR <?php echo $phone11["pkr"]?></h6>
                </div>
            </div>
        </div></a>
        <a href="index12.php"><div class="responsive" >
            <div class="gallery" >
                    <img src="images/<?php echo $phone11["sr."]?>.jpg" alt="image" width="100%;" >
                <div class="desc">
                    <h5><?php echo $phone12["name"]?></h5>
                    <h6>PKR <?php echo $phone12["pkr"]?></h6>
                </div>
            </div>
        </div></a>
